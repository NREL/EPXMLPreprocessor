{ unit NativeXml
  ...
  16-Sep-2005
    Made compatible with Delphi 2005 .NET and Kylix 3
  ...
  20-Sep-2005
    Added TsdStringStream to overcome performance issues with Delphi's TStringStream.
  04-Oct-2005 (thanks to Sebastian Zierer)
    Added AttributeByNameWide property
    Update to NativeXmlObjectStorage.pas to allow widestring properties
  15-Oct-2005
  ...
  29-Nov-2005
    ...
    WriteFloat now uses proprietary routine (threadsafe), always using dots and
    settings from NativeXml.FloatSignificantDigits and FloatAllowScientific
